...
namespace SFA.DAS.Roatp.Functions.UnitTests.Generators
{
    public static class QnaGenerator
    {
        ...
        {
            var answerQuestionPRE20OrganisationNameSoleTrader = "Test Sole Trader";
            ...
            var answerQuestionYO120SoleTrader = "01,2000";
            var tabularDataAnswerQuestionSeq7Sec3 = "{\"Caption\":null,\"HeadingTitles\":[\"First Name\",\"Last Name\",\"Job role\",\"Years in role\",\"Months in role\",\"Part of another organisation\",\"Organisation details\",\"Month\",\"Year\",\"Email\",\"Contact number\"],\"DataRows\":[{\"Id\":\"91baaa9e-5167-46dc-8447-cf6fc36fac31\",\"Columns\":[\"t\",\"t\",\"t\",\"1\",\"1\",\"No\",\"\",\"1\",\"1990\",\"t@t.com\",\"6545645645\"]},{\"Id\":\"64e5f397-7510-410f-8709-141e80c1b9a4\",\"Columns\":[\"t2\",\"t2\",\"t2\",\"2\",\"2\",\"Yes\",\"test\",\"1\",\"1980\",\"t2@t2.com\",\"56456456451\"]},{\"Id\":\"57bf57c2-5323-45e1-9fe4-3ea20c169166\",\"Columns\":[\"r\",\"r\",\"t\",\"3\",\"3\",\"No\",\"\",\"3\",\"1980\",\"r@r.com\",\"56456456451\"]}]}";
            var answerQuestionYO130AddPeopleManualEntry = "{\"Caption\":null,\"HeadingTitles\":[\"Name\",\"Date of birth\"],\"DataRows\":[{\"Id\":\"8787b0b9-e8ea-434b-a03a-3bf53710616a\",\"Columns\":[\"Test\",\"Jan 1990\"]},{\"Id\":\"81b91bac-1272-4743-8dae-ffd83c75757a\",\"Columns\":[\"Test1\",\"Jan 1991\"]}]}";
            return new List<Section>
            {
                GenerateSection(applicationId, 0, 1, "page0", "PRE-20", "Text", answerQuestionPRE20OrganisationNameSoleTrader),
                ...
                GenerateSection(applicationId, 1, 3, "page1", "YO-120", "MonthAndYear", answerQuestionYO120SoleTrader),
                GenerateSection(applicationId, 1, 3, "page1", "YO-130", "TabularData", answerQuestionYO130AddPeopleManualEntry),
                GenerateSection(applicationId, 7, 3, "page7", "question7.3", "TabularData", tabularDataAnswerQuestionSeq7Sec3)
            };
        }
