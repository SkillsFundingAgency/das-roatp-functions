...
public class ApplicationExtract
{
    ...
    private static async Task EnqueueApplyFilesForExtract(List<ApplyFileExtractRequest> applyFileExtractQueue, List<SubmittedApplicationAnswer> answers)
    {
        ...
        {
            applyFileExtractQueue.Add(new ApplyFileExtractRequest(submittedApplicationAnswer));
        }
    }
