...
public class BankHolidayFulfillment
{
    ...
    public async Task Run([TimerTrigger("%BankHolidayFulfillmentSchedule%", RunOnStartup = false)] TimerInfo myTimer)
    {
        ...
        BankHolidayRoot bankHolidaysFromExternalSource = await _govUkApiClient.GetBankHolidays();
